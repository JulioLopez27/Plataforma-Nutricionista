                    ...
                    <section id="BotoneraConsultanteConsultante" className="w-full lg:w-1/4 px-4 ml-4 lg:flex-shrink-0">
                        <div className="sticky top-0">
                            ...
                            <div className="lg:hidden">
                                <button onClick={() => setIsBotoneraConsultanteVisible(!isBotoneraConsultanteVisible)} className="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded w-full">Mostrar BotoneraConsultante</button>
